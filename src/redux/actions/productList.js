...
export const PRODUCT_LIST_FETCH_REQUEST='PRODUCT_LIST_REQUEST';
export const PRODUCT_LIST_FETCH_SUCCESS='PRODUCT_LIST_SUCCESS';
export const PRODUCT_LIST_FETCH_FAILED='PRODUCT_LIST_FAILED';
